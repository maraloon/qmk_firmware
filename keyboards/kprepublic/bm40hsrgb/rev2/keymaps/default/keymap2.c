...
[_DOTENT] = LAYOUT_ortho_4x12_1x2uC(
    _______, _______, _______, _______, _______, _______, _______, _______, KC_COMM,  KC_PDOT, KC_EXLM, _______,
    _______, _______, KC_TAB,  KC_ESC,  _______, _______, _______, KC_QUES, LSFT(KC_ENT), KC_ENT, KC_QUOT, KC_DQUO,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_COLN,  KC_SCLN, _______, _______,
    _______, _______, _______, _______, RGB,     _______,          _______, KC_SPC,   _______, _______, _______
),
...
//  return update_tri_layer_state(state, _DOTENT, _NUMSYM, _RGB);
//}
